...
public class DetailVortaActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (12 < t && t < 15){
                    ...
                    if (check){
                        ...
                        Toast.makeText(DetailVortaActivity.this, "||ADDED TO CART||", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void getDetailFood(final String foodName) {
        vorta.child(foodName).addValueEventListener(new ValueEventListener() {
            @Override
